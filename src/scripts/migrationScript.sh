...
aws dynamodb scan --table-name qa-the-studio-classes --output json --query "Items[*]" > ./src/scripts/classes.json
aws dynamodb scan --table-name qa-the-studio-users --output json --query "Items[*]" > ./src/scripts/users.json
